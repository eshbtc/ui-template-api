...
export default function ChatDetailScreen() {
    ...
    const renderMessage = ({ item }: { item: Message }) => (
        ...
        >
            ...
            >
                <ThemedText className={item.isSent ? 'text-text' : ''}>{item.text}</ThemedText>
                <ThemedText className={`text-xs mt-1 opacity-50 ${item.isSent ? '' : ''}`}>
                    {item.timestamp}
                </ThemedText>
            </View>
        </View>
                    ...
                    <View className="p-4">
                        <View className=" bg-background rounded-xl">
                            ...
                            <TouchableOpacity className="p-4 flex-row items-center justify-between">
                                ...
                                <Icon name="ShieldMinus" size={20} className="mr-3" />
                            </TouchableOpacity>
                        </View>
