...
export default function UserProfileScreen() {
    ...
    return (
        <>
            <Header
                showBackButton
                rightComponents={[<HeaderIcon icon="Instagram" onPress={() => { }} />, <HeaderIcon onPress={() => userActionsSheetRef.current?.show()} icon="MoreHorizontal" />]}
            />
            <AnimatedView
                animation="scaleIn"
        ...
        <View className="p-global">
            <View className="flex-row items-center justify-between">
                <View className="flex-1">
                    ...
                    <ThemedText className="text-base pr-20 mt-4">Addicted to tacos, cerveza and what's left of my sanity.</ThemedText>
                </View>
                <Avatar src={require('@/assets/img/user-2.jpg')} size="lg" />
            </View>
            <View className="flex-row items-center mt-4">
                <Avatar src={require('@/assets/img/user-3.jpg')} size="xxs" className=" border-2 border-background" />
                <Avatar src={require('@/assets/img/user-1.jpg')} size="xxs" className="-ml-2 border-2 border-background" />
            ...
            <View className="flex-row items-center mt-6 gap-2">
                <Button variant={following ? 'outline' : 'primary'} onPress={toggleFollow} title={following ? 'Following' : 'Follow'} className="flex-1" size="small" />
                <Button variant="outline" title="Mention" className="flex-1" size="small" onPress={() => { }} />
            </View>
        </View>
    );
}
...
const mockPosts = [
    {
        ...
        name: 'Bella Hughes',
        time: '2h ago',
        content: 'Behind the scenes from today\'s photoshoot 📸 The perfect blend of elegance and edge',
        images: [
    ...
    },
    {
        ...
        name: 'Bella Hughes',
        time: '6h ago',
        content: 'New collection drop! ✨ Obsessed with these textures and colors. Fashion is all about expressing your inner creativity 💫',
        images: [
...

    {
        ...
        name: 'Bella Hughes',
        time: '4h ago',
        content: 'Working on some new fashion concepts today. Really excited about sustainable fashion! What do you think about eco-friendly materials in high fashion? 🌱',
    },
...

    {
        ...
        name: 'Bella Hughes',
        time: '8h ago',
        content: 'Sometimes the best outfit inspirations come from unexpected places. Just had a breakthrough moment while vintage shopping! 🛍️',
    },
    {
        id: 5,
        src: require('@/assets/img/user-2.jpg'),
        name: 'Bella Hughes',
        time: '12h ago',
        content: 'Golden hour fashion shoot was absolutely magical today! ✨ The way light plays with fabric is pure poetry',
        images: [
            'https://images.unsplash.com/photo-1635776062360-af423602aff3?q=80&w=3132&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
            'https://images.unsplash.com/photo-1579547621706-1a9c79d5c9f1?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
            'https://images.unsplash.com/photo-1604076913837-52ab5629fba9?q=80&w=987&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
        ...
        name: 'Bella Hughes',
        time: '1d ago',
        content: 'Grateful for all the support from this amazing fashion community! You all inspire me every day to keep creating and pushing style boundaries. Thank you! 👗💕',
    },
];
