        ...
        <>
            ...
            >
                ...
                <ThemedScroller className="pt-8 !px-2">
                    <View className="w-full bg-background px-global" style={{ paddingTop: insets.top }}>
                        <Link href="/screens/search" asChild>
                            <Pressable className="flex flex-row border-b border-border py-4 mb-10">
                                <Icon name="Search" size={28} className="mr-4" />
                                <ThemedText className="text-text text-4xl font-semibold">Search</ThemedText>
                            </Pressable>
                        </Link>
                        {/*<Link href="/screens/search" asChild>
